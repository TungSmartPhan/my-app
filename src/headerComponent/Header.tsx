    ...
    <nav className="bg-blue-400 border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
        <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
            <a href="https://flowbite.com" className="flex items-center">
                ...
                <img src="./public/avatar/avatar.jpeg" className="mr-3 h-6 sm:h-9" alt="Suri Logo" />
                <span className="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Suri</span>
            </a>
            ...
            <div className="hidden justify-between items-center w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
                <ul className="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                    <li className="hover:bg-blue-700 focus:ring-gray-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 text-white">
                        <a href="#" className="block py-2 pr-4 pl-3 text-white rounded bg-primary-700 lg:bg-transparent lg:text-primary-700 lg:p-0 dark:text-white " aria-current="page">Home</a>
                    </li>
                    <li className="hover:bg-blue-700 focus:ring-gray-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2">
